...
{
#$value.id , $value.properties.logCollection ,$value.properties.securityContactConfiguration.areNotificationsOn , $value.properties.securityContactConfiguration.securityContactEmails | export-csv "f:\test.csv" -append
